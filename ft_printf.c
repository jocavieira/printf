...
/*   Updated: 2025/05/09 19:01:04 by jocarlo2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	printf("=== printf mixed ===\n");
	int count = printf("int %d, string %s hex: %x, \
	hexU: %X, pointer: %p\n", 42,str, 42, 42, str);
	printf("\n=== ft_printf mixed ===\n");
	...
	printf("count std: %d\n", count);
	printf("\n=== ft_printf characters printed ===\n");
	ft_printf("my count: %d\n", count1);
	printf("\n=== printf string NULL ===\n");
	printf("string NULL: %s\n", (char *)NULL);
	printf("\n=== ft_printf string NULL ===\n");
	ft_printf("string NULL: %s\n", (char *)NULL);
	printf("\n=== ft_printf pointer NULL ===\n");
	ft_printf(" %p %p \n", 0, 0);
	printf("\n=== printf pointer NULL ===\n");
	printf(" %p %p \n", 0, 0);
}*/
